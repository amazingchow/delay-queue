...
class TaskDelayQueueServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.PushTask = channel.unary_unary(
                '/amazingchow.photon_dance_delay_queue.TaskDelayQueueService/PushTask',
        ...
        self.FinishTask = channel.unary_unary(
                '/amazingchow.photon_dance_delay_queue.TaskDelayQueueService/FinishTask',
        ...
        self.CheckTask = channel.unary_unary(
                '/amazingchow.photon_dance_delay_queue.TaskDelayQueueService/CheckTask',
        ...
        self.SubscribeTopic = channel.unary_unary(
                '/amazingchow.photon_dance_delay_queue.TaskDelayQueueService/SubscribeTopic',
        ...
        self.UnsubscribeTopic = channel.unary_unary(
                '/amazingchow.photon_dance_delay_queue.TaskDelayQueueService/UnsubscribeTopic',
...
def add_TaskDelayQueueServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'amazingchow.photon_dance_delay_queue.TaskDelayQueueService', rpc_method_handlers)
...
class TaskDelayQueueService(object):
    ...
    def PushTask(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/amazingchow.photon_dance_delay_queue.TaskDelayQueueService/PushTask',
    ...
    def FinishTask(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/amazingchow.photon_dance_delay_queue.TaskDelayQueueService/FinishTask',
    ...
    def CheckTask(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/amazingchow.photon_dance_delay_queue.TaskDelayQueueService/CheckTask',
    ...
    def SubscribeTopic(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/amazingchow.photon_dance_delay_queue.TaskDelayQueueService/SubscribeTopic',
    ...
    def UnsubscribeTopic(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/amazingchow.photon_dance_delay_queue.TaskDelayQueueService/UnsubscribeTopic',
